...
\begin{frame}{\titleicon{Local Software Execution}{workstation}}
    \begin{figure}
        \begin{tikzpicture}[xscale=5]
            ...
            \draw[thick,-{Stealth}] (s) -- node[font=\footnotesize,above] {Execute\vphantom{Jpy}} node[font=\footnotesize,below] {Software} (w);
...
\begin{frame}{\titleicon{Cluster Software Execution}{cluster}}
    \begin{figure}
        \begin{tikzpicture}[xscale=5]
            ...
            \node[anchor=north,align=center] at (u.south) {Programmer};
            \node[anchor=north,align=center] at (s|-u.south) {Software};
            \node[anchor=north,align=center] at (c|-u.south) {\href{https://informatica.doc.iiia.csic.es/cap-ia/}{CAP-IA}/\href{https://cesga-docs.gitlab.io/ft3-user-guide/overview.html\#node-groups-description}{CESGA}};
        \end{tikzpicture}
    \end{figure}
\end{frame}
